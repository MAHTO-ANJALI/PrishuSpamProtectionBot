...
async def help_command(_, message: Message):
    ...
    kb = ikb(
        {
            "Help": "bot_commands",
            "Repo": "https://github.com/MAHTO-ANJALI/PrishuSpamProtectionBot",
            "Add Me To Your Group": f"https://t.me/{BOT_USERNAME}?startgroup=new",
            "Support Chat (for now)": "https://t.me/DANGEROUS_FIGHTER_GROUP",
        }
    )
    mention = message.from_user.mention
    await message.reply_photo(
        "https://hamker.me/logo_3.png",
        caption=f"Hi {mention}, I'm DangerousSpamProtectionBot,"
...
async def help_parser(name, keyboard=None):
    ...
    return (
        f"Hello {name}, I'm DangerousSpamProtectionBot, I can protect "
...
async def help_button(client, query: CallbackQuery):
    ...
    top_text = (
        f"Hello {u}, I'm DangerousSpamProtectionBot, I can protect "
        + "your group from Spam and NSFW media using "
        + "machine learning. Choose an option from below."
    )
    if mod_match:
